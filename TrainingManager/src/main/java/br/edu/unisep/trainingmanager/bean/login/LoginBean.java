package br.edu.unisep.trainingmanager.bean.login;

import br.edu.unisep.trainingmanager.bean.user.UserBean;
import br.edu.unisep.trainingmanager.dto.login.LoginDto;
